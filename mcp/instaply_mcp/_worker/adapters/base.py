...
# Default Playwright selectors to attempt when no adapter is matched.
# Conservative — works on most plain HTML forms, but each adapter SHOULD
# override `submit_selectors` with its own list for reliability.
...
class AtsAdapter(Protocol):
    kind: AtsKind
    # Ordered list of Playwright selectors the executor tries when looking
    # for the submit button. First one that matches a visible element +
    # clicks without throwing wins. Adapters define this as a class attr.
