...
MODEL_LADDER: list[ModelRec] = [
    ...
    ModelRec("qwen3:14b",          "Qwen 3 14B",          9.3,  12, "great",
             "fits entirely in a 12 GB GPU — best quality/speed balance for most gaming laptops"),
    ModelRec("qwen3:30b-a3b",      "Qwen 3 30B (MoE)",    19.0, 24, "best",
             "mixture-of-experts, only ~3B params active per token — stays fast even partially offloaded"),
