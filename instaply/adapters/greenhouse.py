...
class GreenhouseAdapter:
    ...
    # Greenhouse renders submit as either an <input type=submit> on the
    # legacy boards.greenhouse.io HTML form, or a styled <button> on the
    # newer Remix-based job-boards.greenhouse.io. Try the most specific
    # markers first so we don't accidentally click an "Add another" or
