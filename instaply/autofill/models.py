...
class UserProfile(BaseModel):
    ...
    # Free-form. Distinct from gender — pronouns are NEVER inferred from
    # gender. Auto-fill only when this field is explicitly set; otherwise
    # the worker escalates pronouns questions to needs_review.
    ...
    resume_text_excerpt: Optional[str] = None        # grounded raw text snippet for LLM fallback
